...
// Use Regex to be perfectly safe about whitespaces
const regex = /const isCreatorFolder =[\s\S]*?<div className=\{`border-t px-3 pb-3 pt-3 \$\{isCreatorFolder \? "border-\[#E7D39A\]" : "border-\[#EDE6DD\]"\}`\}>/m;
