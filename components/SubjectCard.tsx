...
export function SubjectCard({ subject, careerId }: { subject: Subject; careerId?: string }) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col justify-between h-full rounded-xl border border-[#E3DCD2] bg-white p-4 hover:-translate-y-1 hover:border-[#B2C7B6] hover:shadow-[0_8px_24px_rgba(139,170,145,0.12)] transition-all duration-400 relative overflow-hidden"
    >
      <div 
